    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', bgcolor: 'background.default' }}>
      ...
      <Container maxWidth="md" sx={{ py: 4, flexGrow: 1 }}>
        <Breadcrumbs separator={<NavigateNext fontSize="small" />} sx={{ mb: 3 }}>
          <Link component={RouterLink} to="/dashboard" underline="hover" color="text.secondary">Кабінет</Link>
          <Link component={RouterLink} to="/appeals" underline="hover" color="text.secondary">Звернення</Link>
          <Typography color="text.primary">Нове звернення</Typography>
        </Breadcrumbs>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 4 }}>
          ...
          <Box>
            <Typography variant="h4" fontWeight={700}>Нове звернення</Typography>
            <Typography color="text.secondary">Заповніть форму та подайте своє звернення</Typography>
          </Box>
        </Box>
        ...
        <Paper sx={{ p: { xs: 3, sm: 5 } }}>
          <Typography variant="body2" color="text.secondary" sx={{ mb: 3, p: 2, bgcolor: 'info.50', borderRadius: 2, border: '1px solid', borderColor: 'info.200' }}>
            💡 Ваше звернення буде розглянуто протягом 48 робочих годин. Ви отримаєте відповідь на цьому порталі.
          </Typography>
